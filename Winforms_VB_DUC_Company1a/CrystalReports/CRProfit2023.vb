...
Public Class CRProfit2023
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Winforms_VB_DUC_Company1a.CRProfit2023.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRProfit2023
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRProfit2023 = New CRProfit2023()
        rpt.Site = Me.Site
        Return rpt
    End Function
